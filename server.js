...
async function api(req, res, pathname) {
  ...
  try {
    ...
    if (pathname === '/api/positions/assets' && req.method === 'GET') return json(res,200,{assets:[{symbol:'MNQ',label:'MNQ · Micro E-mini Nasdaq-100',market:'Futuros EUA',quantityLabel:'Contratos',feed:'CME via feed público'},{symbol:'BTCUSDT',label:'BTC / USDT',market:'Cripto · Binance',quantityLabel:'BTC',feed:'Binance'},{symbol:'ETHUSDT',label:'ETH / USDT',market:'Cripto · Binance',quantityLabel:'ETH',feed:'Binance'},{symbol:'SOLUSDT',label:'SOL / USDT',market:'Cripto · Binance',quantityLabel:'SOL',feed:'Binance'},{symbol:'CAKEUSDT',label:'CAKE / USDT',market:'Cripto · Binance',quantityLabel:'CAKE',feed:'Binance'}]});
